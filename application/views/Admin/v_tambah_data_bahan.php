    ...
    '<tr class="border'+i+'" id="row_soal">'+
        '<td>'+
            '<div class="md-form mt-1">'+
                '<input type="text" id="materialContactFormName" class="form-control" name="kode_bahan['+i+']" placeholder="">'+
            '</div>'+
        '</td>'+
        '<td>'+
            '<div class="md-form mt-1">'+
                '<input type="text" id="materialContactFormName" class="form-control" name="nama_bahan['+i+']" placeholder="">'+
            '</div>'+
        '</td>'+
        '<td>'+
            '<div class="md-form mt-1">'+
        ...
        '<td>'+
            '<div class="md-form mt-1">'+
                '<input type="text" id="materialContactFormName" class="form-control" name="kategori['+i+']" required>'+
            '</div>'+
        '</td>'+
        '<td>'+
            '<div class="md-form mt-1">'+
                '<input type="text" id="materialContactFormName" class="form-control" name="kondisi['+i+']" required>'+
            '</div>'+
        '</td>'+
        '<td>'+
            '<div class="md-form mt-1">'+
                '<input type="text" id="materialContactFormName" class="form-control" name="kadaluarsa['+i+']" required>'+
            '</div>'+
        '</td>'+
        '<td>'+
